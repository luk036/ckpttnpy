...
This code defines a class called FMGainMgr (Fiduccia-Mattheyses Gain Manager) which is used in
...
The FMGainMgr class takes three main inputs: a GainCalc object (which calculates gains),
