...
# -*- coding: utf-8 -*-
"""
Setup script for ckpttnpy

You can install ckpttnpy with
...
if sys.version_info[:2] < (2, 7):
    print("ckpttnpy requires Python 2.7 or later (%d.%d detected)." %
          sys.version_info[:2])
    sys.exit(-1)

# Write the version information.
sys.path.insert(0, 'ckpttnpy')
...
# docdirbase = 'share/doc/ckpttnpy-%s' % version
...
extras_require = {'all': ['networkx', 'matplotlib']}
